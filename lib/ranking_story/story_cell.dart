...
class StoryCell extends StatelessWidget {
  final StoryEntity element;

  StoryCell(this.element);

  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
         AppNavigator.pushStoryDetail(context,element.wid!.toInt(), element.id!.toInt());
      },
      child: Container(
        ...
        child: Row(
          ...
          children: <Widget>[
            NovelCoverImage(element.imgUrl??"", width: 70, height: 93),
            SizedBox(width: 15),
            Expanded(
              child: buildRight(),
            ),
