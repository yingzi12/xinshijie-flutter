...
class AuthorApi {
  ...
  // 类变量（静态变量）
  static String info ="/wiki/author/info";

  static String list ="/wiki/author/list";

  static String add ="/wiki/author/add";


  static String del ="/wiki/author/del";


  static String edit ="/wiki/author/edit";
