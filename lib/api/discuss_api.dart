...
class DiscussApi {
  ...
  // 类变量（静态变量）
  static String info ="/wiki/discuss/info";

  static String list ="/wiki/discuss/list";

  static String add ="/wiki/discuss/add";


  static String del ="/wiki/discuss/del";


  static String edit ="/wiki/discuss/edit";
