...
class ManageApi {
  ...
  // 类变量（静态变量）
  static String info ="/wiki/manage/info";

  static String list ="/wiki/manage/list";

  static String add ="/wiki/manage/add";


  static String del ="/wiki/manage/del";


  static String edit ="/wiki/manage/edit";
