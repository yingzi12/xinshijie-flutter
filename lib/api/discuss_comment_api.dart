...
class DiscussCommentApi {
  ...
  // 类变量（静态变量）
  static String info ="/wiki/discussComment/info";

  static String list ="/wiki/discussComment/list";

  static String add ="/wiki/discussComment/add";


  static String del ="/wiki/discussComment/del";


  static String edit ="/wiki/discussComment/edit";
