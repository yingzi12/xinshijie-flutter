...
class _ElementListPageState extends State<ElementListPage> {
  ...
  void reloadData({String searchQuery = ''}) async {
    ...
    // 例如：
    List<ElementEntity> elist = await ElementApi.getList({
  ...
  void _loadMore() async {
    ...
    List<ElementEntity>  elist= await ElementApi.getList({"pageNum" : currentPage.toString(),"wid":wid.toString()});
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return ElementCell(stories[index]);
              },
            ),
          ),
        ],
