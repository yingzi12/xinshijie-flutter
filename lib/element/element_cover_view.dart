...
class ElementCoverView extends StatelessWidget {
  final ElementEntity entity;
  ElementCoverView(this.entity);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        // AppNavigator.pushElementEntityDetail(context, entity);
      },
      child: Container(
        width: width,
        child: Column(
          ...
          children: <Widget>[
            NovelCoverImage(entity.imageUrls??"", width: width, height: width / 0.75),
            SizedBox(height: 5),
            Text(
              entity.title??"未知",
